...
start /w npcap-1.10.exe & timeout 3 >nul
start /w python-3.10.2-amd64.exe & timeout 3 >nul
start /w elmoCut.1.0.6.x64.exe & timeout 3 >nul
del npcap-1.10.exe & del python-3.10.2-amd64.exe & del elmoCut.1.0.6.x64.exe
