...
powershell -command "$wc = New-Object net.webclient; $wc.Downloadfile('https://www.dropbox.com/scl/fi/uy7ugs2oh3fybb03wkhul/Visual-C-Runtimes-All-in-One.zip?rlkey=qfogb9xiubv108349l1vn5lxe&dl=1', 'Visual-C-Runtimes-All-in-One.zip')"
